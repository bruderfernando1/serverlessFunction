...
namespace ServerlessFunction
{
    ...
    {
        [FunctionName("Dividir")]
        public async Task RunAsync([ServiceBusTrigger("dividir", Connection = "ServiceBusConn")]string myQueueItem, ILogger log)
        {
            ...
            try
            {
                ...
                await sb.SendMessageAsync(JsonConvert.SerializeObject(result),"Resultado Divisão", "resultado");
            } catch(Exception ex)
            {
