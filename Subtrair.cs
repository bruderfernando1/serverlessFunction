...
namespace ServerlessFunction
{
    ...
    {
        [FunctionName("Subtrair")]
        public async Task RunAsync([ServiceBusTrigger("subtrair", Connection = "ServiceBusConn")]string myQueueItem, ILogger log)
        {
            ...
            try
            {
                ...
                await sb.SendMessageAsync(JsonConvert.SerializeObject(result), "Resultado Subtração", "resultado");
            } catch(Exception ex)
            {
